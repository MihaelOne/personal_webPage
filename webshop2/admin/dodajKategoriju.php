                                ...
                                <div class="card-body">
                                    <form action="code.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="">Ime</label>
                                                <input type="text" name="ime" class="form-control" placeholder="">
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea row="3" name="opis" class="form-control" placeholder=""></textarea>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea row="3" name="meta_description" class="form-control" placeholder=""></textarea>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="">Meta keywords</label>
                                                <textarea row="3" name="meta_keywords" class="form-control" placeholder=""></textarea>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" name="add_article_btn">Spremi</button>
                                            </div>
                                    </form>
                                </div>
