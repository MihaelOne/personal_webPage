                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="functions/authcode.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <!-- <label for="inputIme">Prezime</label> -->
                                    ...
                                    <div class="form-group">
                                        <!-- <label for="exampleInputEmail1">Email address</label> -->
                                        <input type="number" name="telefon" class="form-control" id="inputPhone" aria-describedby="emailHelp" placeholder="Broj mobitela">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <!-- <label for="exampleInputPassword1">Password</label> -->
                                        <input type="password" name="cpassword" class="form-control" id="InputPassword2" placeholder="Potvrda lozinke">
                                    </div>
                                    <!-- <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                    <label class="form-check-label" for="exampleCheck1">Check me out</label>
                                </div> -->
                                    <button type="submit" name="register_btn" class="btn btn-success">Potvrdi registraciju</button>
                                </form>
                            </div>
                        </div>
